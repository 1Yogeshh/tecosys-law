      ...
      <div style={{alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column"}}>
        ...
        {!showSummary ? (
          <div className="query-input-box lg:min-w-[70vh] w-[300px]">
            ...
            <button className="bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-500 focus:outline-none" onClick={handleGenerateSummary} style={{ margin: "0 auto" }}>Show Summary</button>
          </div>
        ) : (
          <>
