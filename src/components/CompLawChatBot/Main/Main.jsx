      ...
      <div className="main-container lg:ml-[180px] ml-[10px]">
        <>
          ...
          {!hideDefaultQuestions && (
            <div className="w-[600px] flex flex-wrap gap-4 ml-[110px] mt-[120px]">
              {defaultQuestions.map((item, index) => {
                ...
                return (
                  <button
                    key={index}
                    className={`w-[280px] h-[150px] font-medium rounded-lg flex gap-2 justify-center items-center border-[2px] p-2 ${currentColors.borderColor}`}
